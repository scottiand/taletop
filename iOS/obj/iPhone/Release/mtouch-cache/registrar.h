...
@class FableDevice_iOS_AutoLabelRenderer;
@class Xamarin_Forms_Platform_iOS_ButtonRenderer;
@class FableDevice_iOS_NoPaddingButtonRenderer;
@class Xamarin_Forms_Platform_iOS_ScrollViewRenderer;
@class FableDevice_iOS_RuleBookScrollViewRenderer;
...
@interface FableDevice_iOS_AutoLabelRenderer : Xamarin_Forms_Platform_iOS_LabelRenderer {
}
	-(id) init;
@end
...
@interface FableDevice_iOS_NoPaddingButtonRenderer : Xamarin_Forms_Platform_iOS_ButtonRenderer {
}
	-(id) init;
@end
...
@interface FableDevice_iOS_RuleBookScrollViewRenderer : Xamarin_Forms_Platform_iOS_ScrollViewRenderer {
}
	-(id) init;
@end
