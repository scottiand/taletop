...
extern void *mono_aot_module_FableDevice_iOS_info;
...
extern void *mono_aot_module_FableDevice_info;
...
extern void *mono_aot_module_FormsCommunityToolkit_Effects_info;
extern void *mono_aot_module_FormsCommunityToolkit_Effects_iOS_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_FableDevice_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_FableDevice_info);
	...
	mono_aot_register_module (mono_aot_module_FormsCommunityToolkit_Effects_info);
	mono_aot_register_module (mono_aot_module_FormsCommunityToolkit_Effects_iOS_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "FableDevice.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
