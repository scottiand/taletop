...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "FableDevice.Droid.dll" comes first in this list. */
		"FableDevice.Droid.dll",
		"ExifLib.dll",
		"FableDevice.dll",
		"FormsCommunityToolkit.Effects.Android.dll",
		"FormsCommunityToolkit.Effects.dll",
		"FormsViewGroup.dll",
		"SQLite-net.dll",
